...
import QuizResult from "./quiz-resulr"; // make sure this is correct
...
export default function Quiz() {
  ...
  const saveQuizResultFn = async (quizData, answers, score) => {
    setSavingResult(true);
    try {
      const res = await fetch("/api/quiz/save", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ quizData, answers, score }),
      });
